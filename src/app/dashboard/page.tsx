    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 w-full gap-6 lg:p-8">
            <div className="flex flex-col md:col-span-1 xl:col-span-4 gap-6 w-full">
                <div className="flex flex-col items-center justify-center w-full border border-border/60 border-gray-700 rounded-xl py-6 md:py-8">
                ...
                <div className="flex flex-col items-start w-full border border-border/60 border-gray-700 rounded-xl py-6 md:py-8 px-4 md:px-6">
            ...
            <div className="flex flex-col md:col-span-1 xl:col-span-8 gap-8 w-full">
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 w-full">
                    <MagicCard color="rgba(239,68,68,.08)" className="border-2 border-gray-700 max-w-full w-full">
                    ...
                    <MagicCard color="rgba(217,70,239,.1)" className="border-2 border-gray-700 max-w-full w-full">
                    ...
                    <MagicCard color="rgba(99,102,241,.08)" className="border-2 border-gray-700 max-w-full w-full">
