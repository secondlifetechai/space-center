    ...
    return (
        <div className="flex flex-col items-start justify-start w-full max-w-3xl py-8 mx-auto">
            ...
            <div className="flex flex-col items-start w-full py-8 gap-y-8">
                ...
                <div>
                    <Link href="/dashboard/account/settings" className={buttonVariants({ size: "sm", variant: "black", className: "rounded-sm bg-primary px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80" })}>
                        Update symptom
                    </Link>
                </div>
            </div>
