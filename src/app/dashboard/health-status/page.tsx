                    ...
                    {symptoms.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-6">
                            {symptoms.map((symptom) => (
                                <Card key={symptom.id} className="border border-gray-700">
                                    <CardHeader>
                    ...
                    {medications.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-6">
                            {medications.map((medication) => (
                                <Card key={medication.id} className="border border-gray-700">
                                    <CardHeader>
                                        <CardTitle className="capitalize text-xl">
                    ...
                    {mentalWellness.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-6">
                            {mentalWellness.map((wellness) => (
                                <Card key={wellness.id} className="border border-gray-700">
