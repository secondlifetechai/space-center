    ...
    return (
        <div
            className={cn(
                ...
                show ? "hidden sm:block sm:fixed border-r border-border border-r-gray-800" : "block relative w-full",
            )}
        >
            <div className={cn(
                                ...
                                <Tooltip key={link.label} delayDuration={0}>
                                    <TooltipTrigger asChild>
                                        ...
                                        >
                                            ...
                                            <TooltipContent side="right" className="text-xs hidden sm:flex text-neutral-400">
                                                {link.label}
                                            </TooltipContent>
                                        </li>
                                    </TooltipTrigger>
