...
const DashboardNavbar = ({ isPro }: Props) => {
    ...
    return (
        <header className="sticky top-0 inset-x-0 h-14 w-full px-2 sm:px-4 border-b border-border bg-background backdrop-blur-md border-gray-800 z-50">
                ...
                <div className="flex items-center gap-4">
                    {!isPro && (
                        <Button asChild size="sm" variant="secondary">
                            <Link href="/dashboard/account/billing" className="text-gray-400">
                                Upgrade
                            </Link>
                        </Button>
                    )}
