  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        It's time to make your health simpler, smarter, and more personalized. With Space Center, your well-being is in great hands.
      </p>
      <div>
        <input
          type="text"
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#234233" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
